...
public class OnScreenIndicators {
    ...
    public void onOrientationChanged(int orientation) {
        mOnScreenIndicators.setRotation(orientation);
    }

    public void setIconEnabledAlpha(boolean enabled) {
        // TODO Auto-generated method stub
        if (enabled) {
            mExposureIndicator.setAlpha(ENABLED_ALPHA);
            mFlashIndicator.setAlpha(ENABLED_ALPHA);
            mSceneIndicator.setAlpha(ENABLED_ALPHA);
            mLocationIndicator.setAlpha(ENABLED_ALPHA);
            mTimerIndicator.setAlpha(ENABLED_ALPHA);
            mWBIndicator.setAlpha(ENABLED_ALPHA);
        } else {
            mExposureIndicator.setAlpha(DISABLED_ALPHA);
            mFlashIndicator.setAlpha(DISABLED_ALPHA);
            mSceneIndicator.setAlpha(DISABLED_ALPHA);
            mLocationIndicator.setAlpha(DISABLED_ALPHA);
            mTimerIndicator.setAlpha(DISABLED_ALPHA);
            mWBIndicator.setAlpha(DISABLED_ALPHA);
        }
    }
}
