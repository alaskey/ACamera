...
public class VideoUI implements PieRenderer.PieListener,
    ...
    private LinearLayout mRecordingTimeLinearLayout;
     ...
     */
    public void animateCapture(boolean mirror) {
        Bitmap bitmap = null;
    ...
    private void initializeMiscControls() {
        ...
        mRecordingTimeLinearLayout = (LinearLayout)mRootView.findViewById(R.id.ll_recording_time);
    ...
    public void requestLayoutRecordingTimeRect() {
        if(null != mRecordingTimeRect) {
            mRecordingTimeRect.requestLayout();
        }
    }
    ...
    public void showRecordingUI(boolean recording) {
        ...
        if (recording) {
            int mDisplayRotation = CameraUtil.getDisplayRotation(mActivity);
            if (mDisplayRotation == 180) {
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
                        LinearLayout.LayoutParams.MATCH_PARENT,
                        LinearLayout.LayoutParams.MATCH_PARENT);
                lp.setMargins(0, 0, 0, 23);

                mLabelsLinearLayout.setGravity(Gravity.BOTTOM);
                mLabelsLinearLayout.setLayoutParams(lp);
                mRecordingTimeLinearLayout.setGravity(Gravity.BOTTOM);
            } else {
                mLabelsLinearLayout.setGravity(Gravity.TOP);
                mRecordingTimeLinearLayout.setGravity(Gravity.TOP);
            }
    ...
    public void dismissRestoreDefaults(boolean topPopupOnly) {
        mVideoMenu.popupDismissed(topPopupOnly);
    }
